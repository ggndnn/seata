 ...
 * @author zhaojun
 */
class NettyClientChannelManagerAp2LockCas extends BaseNettyClientChannelManager {
    private static final Logger LOGGER = LoggerFactory.getLogger(NettyClientChannelManagerAp2LockCas.class);
    ...
    NettyClientChannelManagerAp2LockCas(final NettyPoolableFactoryAp2 keyPoolableFactory,

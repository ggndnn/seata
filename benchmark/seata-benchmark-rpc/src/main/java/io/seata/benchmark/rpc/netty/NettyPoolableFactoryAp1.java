 ...
 * @date 2018 /11/19
 */
public class NettyPoolableFactoryAp1 implements KeyedPoolableObjectFactory<NettyPoolKey, Channel> {
    private static final Logger LOGGER = LoggerFactory.getLogger(NettyPoolableFactoryAp1.class);

    private RpcClientMock rpcRemotingClient = new RpcClientMock();

    private final RpcClientBootstrap clientBootstrap;

    public NettyPoolableFactoryAp1(RpcClientBootstrap clientBootstrap) {

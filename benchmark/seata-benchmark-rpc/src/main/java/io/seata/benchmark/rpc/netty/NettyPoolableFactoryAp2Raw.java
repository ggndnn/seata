 ...
 * @author ggndnn
 */
public class NettyPoolableFactoryAp2Raw implements KeyedPooledObjectFactory<String, Channel> {
    private static final Logger LOGGER = LoggerFactory.getLogger(NettyPoolableFactoryAp2Raw.class);

    private final RpcClientBootstrap clientBootstrap;

    public NettyPoolableFactoryAp2Raw(RpcClientBootstrap clientBootstrap) {
        this.clientBootstrap = clientBootstrap;
    }

    @Override
    public PooledObject<Channel> makeObject(String key) {

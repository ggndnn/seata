 ...
 * @author zhaojun
 */
class NettyClientChannelManagerAp1Lock extends BaseNettyClientChannelManager {
    private static final Logger LOGGER = LoggerFactory.getLogger(NettyClientChannelManagerAp1Lock.class);
    ...
    NettyClientChannelManagerAp1Lock(final NettyPoolableFactoryAp1 keyPoolableFactory,

 ...
 * @author zhaojun
 */
class NettyClientChannelManagerAp1NoLock extends BaseNettyClientChannelManager {
    private static final Logger LOGGER = LoggerFactory.getLogger(NettyClientChannelManagerAp1NoLock.class);
    ...
    NettyClientChannelManagerAp1NoLock(final NettyPoolableFactoryAp1Raw2 keyPoolableFactory,

...
public class DruidIsolationClassLoader extends URLClassLoader {
    private final static String[] DRUID_CLASS_PREFIX = new String[]{"com.alibaba.druid.", "io.seata.rm.datasource.sql.druid"};

    public DruidIsolationClassLoader() {
        super(getDruidUrls(), DruidIsolationClassLoader.class.getClassLoader());
    }
    ...
    private static URL[] getDruidUrls() {
        List<URL> urls = new ArrayList<>();
        urls.add(findClassLocation(DruidIsolationClassLoader.class));
        urls.add(findClassLocation(StringUtils.class));

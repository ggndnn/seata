...
public class SQLVisitorFactory {
    /**
     * Druid isolation classLoader.
     */
    private final static ClassLoader CLASS_LOADER = new DruidIsolationClassLoader();
    ...
    static {
        SQL_RECOGNIZER_FACTORY = EnhancedServiceLoader.load(SQLRecognizerFactory.class, CLASS_LOADER);
    }
